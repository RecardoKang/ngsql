...
define('common', ['jquery'], function (j) {
    return j.extend(this.prototype, {
        //html标签(来自W3CSchool,20200806)
        htmlTag: ['a', '!DOCTYPE', 'abbr', 'acronym', 'address', 'applet', 'area', 'article', 'aside', 'audio', 'b',
            'base', 'basefont', 'bdi', 'bdo', 'big', 'blockquote', 'body', 'br', 'button', 'canvas', 'caption',
            'center', 'cite', 'code', 'col', 'colgroup', 'command', 'datalist', 'dd', 'del', 'details', 'dfn', 'dialog',
